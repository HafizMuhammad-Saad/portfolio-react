...
const skillItem = [
    ...
    {
      imgSrc: '/public/images/supabase-logo-icon.png',
      label: 'Supabase',
      desc: 'Database'
    },
    {
    ...
    <section className="section">
        <div className="container">
            ...
            <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] reveal-up">
                Discover the powerfool tools and technologies I use to create exceptional, high-performing websites & applications.
            </p>
