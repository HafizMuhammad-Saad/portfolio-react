const socialLinks = [
    {
      href: 'https://www.github.com/HafiMuhammad-Saad',
  ...
  return (
   <section className="section" id="contact">
    <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        ...
        <div className="mb-12 lg:mb-0 lg:flex-cols">
            <h2 className="headline-2 lg:max-w-[12ch] reveal-up">
                Contact me for colloboration
            </h2>

            <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up">
                Reach out today to discuss your project needs and start colloborating on something amazing
            </p>
        ...
        <form action="https://getform.io/f/bejrxgva" method="POST" className="xl:pl-10 2xl:pl-20">
            <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                ...
                <div className="mb-4">
                    ...
                    <input type="text" name="name" id="name" autoComplete="name" required placeholder="Saad" className="text-field reveal-up" />
                </div>
                ...
                <div className="mb-4">
                    ...
                    <input type="email" name="email" id="email" autoComplete="email" required placeholder="studentsaad41@gmail.com" className="text-field reveal-up" />
                </div>
